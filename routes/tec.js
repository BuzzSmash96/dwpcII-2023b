...
router.get('/', function(req, res, next) {
  ...
  router.get('/api/tec', function(_, res) {
    ...
    res.json({
      ...
      description: `Universidad Tecnologica De El TCNM, con una trayectoria amplia en la formación de Ingenieros especializados y preparados para el campo laboral, con apititudes y diferentes habilidades.`,
